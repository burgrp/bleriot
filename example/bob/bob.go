...
// host "bleriot gen" command, which generates a tiny main() that calls
// bleriotMain (this file) with a node.Provisioning value and a spec.Config. That
// generated main lives in provisioning_gen.go (gitignored, regenerated by the
// Makefile).
//
// On boot bleriotMain:
...
// main() that supplies prov and cfg is generated (provisioning_gen.go).
